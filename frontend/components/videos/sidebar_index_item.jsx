...
const SideBarIndexItem=props=>{
    ...
    <div class='sidebar-index-item'>
        <div class='image-container-sidebar'>
            <Link to={`${props.video.id}`}><img class='thumbnail-sidebar' src={props.video.thumbnailUrl}/></Link>
        </div>
        <div class='video-index-info-container-sidebar'>
            <div class='video-index-title-sidebar'> <Link class='video-index-title-link-sidebar'to={`${props.video.id}`}>{props.video.title}</Link></div>    
